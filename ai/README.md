...
- **Trade Service (P2P)**: [`../trade.md`](../trade.md)
- **Глоссарий**: [`glossary.md`](./glossary.md)

## Навигация

- Вопросы про **ошибки интеграции** (401/403/40002/40403 и т.п.) → Postman-коллекция или `../aggregator.md`
- Вопросы про **форматы запросов/ответов/подписи** → Postman-коллекция
- Вопросы про **P2P, трейдеров, SMS, Telegram бот** → `../trade.md`
